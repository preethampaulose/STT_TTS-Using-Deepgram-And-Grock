...
MODEL_NAME = "alpha-stella-en-v2"  # Example model name
...
text = """ The idea of a clutter-free closet might seem impossible, but these closet organization ideas prove otherwise. """
